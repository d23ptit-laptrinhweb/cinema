...
public class BookingCleanupJob {
    ...
    /**
     * Chạy mỗi 2 phút để quét và giải phóng các booking PENDING đã hết hạn.
     * Xử lý trường hợp người dùng bỏ qua thanh toán mà không có IPN callback từ VNPay.
     */
    ...
    public void releaseExpiredBookings() {
        ...
        log.info("[BookingCleanupJob] Tìm thấy {} booking hết hạn, đang giải phóng...", expiredBookings.size());
        ...
        for (Booking booking : expiredBookings) {
            try {
                ...
                log.error("[BookingCleanupJob] Lỗi khi giải phóng booking {}: {}",
